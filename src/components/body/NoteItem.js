        ...
        <>
            ...
            <Grid container className="mb-3 bg-light" style={{ width: '96%', marginLeft: '2%', marginRight: '2%', borderRadius: '10px' }}>
                <Grid className="card-body">
                    ...
                    <Grid item lg={6} className="d-inline-block mr-5" style={{ fontFamily: "Georgia", fontSize: '1em', fontStyle: 'italic', fontWeight: 'bold', marginTop: '-12px' }}>Special title treatment</Grid>
                    ...
                    <Grid item lg={12} className="">
                        ...
                        <div className="text-center d-inline-block mx-5" style={{ paddingLeft: '10px', paddingRight: '10px', borderStyle: 'solid', borderRadius: '10px', color: 'white', backgroundColor: '#4B0082', marginBottom: '-3px' }}>tag</div>
