...
export default function NoConnection({ theme }) {
    return (
        <>
            ...
            <div style={{  display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', marginTop: '20px', fontFamily: 'Georgia Verdana', fontStyle: 'italic', fontSize: '24px', color: theme==='dark' ? 'whitesmoke' : '' }}>
